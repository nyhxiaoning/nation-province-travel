 ...
 * @LastEditTime: 2024-09-02 10:41:41
    ...
    <section className="relative">
      ...
      <div className="relative">
        {/* <div className="py-12 md:py-20"> */}
          ...
          <h2 className="h2 mb-4 pb-8 pt-12">上下两张图页面</h2>
          ...
          <div className="w-full flex flex-col items-center">
            ...
            {/* 2nd item */}
            <div className="relative w-full flex flex-col items-center p-6 bg-white rounded shadow-xl">
            <Image className="w-full h-auto mx-auto rounded scale-110" src={FeaturesBg2} alt="Features bg" />
            </div>
        </div>
